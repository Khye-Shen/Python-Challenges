...
r1 = Rotor("DMTWSILRUYQNKFEJCAZBPGXOHV", 1)
r2 = Rotor("HQZGPJTMOBLNCIFDYAWVEUSRKX", 2)
reflector = Reflector("QYHOGNECVPUZTFDJAXWMKISRBL")


machine = Machine([r1, r2], reflector)

x = machine.encipher("CS IS THE BEST")
print(x)
